...
export default class NumericMinimumInputtedValueValidationRule extends InputtedValueValidationRule {
  ...
  public isValid(rawValue: unknown): boolean {
    ...
    if (!isNumber(rawValue)) {
      ...
      Logger.logError({
        ...
        occurrenceLocation: "NumericMinimumInputtedValueValidationRule.isValid(rawValue)"
      });
